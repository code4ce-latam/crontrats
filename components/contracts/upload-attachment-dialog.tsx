...
export function UploadAttachmentDialog({
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const uploadUrlResponse = await fetch("/api/contracts/attachment/upload-url", {
        method: "POST",
        headers: {
      ...
      const { storage_path, signed_url } = await uploadUrlResponse.json();
      ...
      if (uploadError) {
        console.error("[UploadAttachmentDialog] Error en upload:", uploadError);
      ...
      const confirmResponse = await fetch("/api/contracts/attachment/confirm-upload", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      console.error("[UploadAttachmentDialog] Error:", err);
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Subir archivo adicional</DialogTitle>
          <DialogDescription>
            Selecciona un archivo para adjuntar al contrato
          </DialogDescription>
        </DialogHeader>

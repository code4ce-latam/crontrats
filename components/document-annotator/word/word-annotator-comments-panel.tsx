...
import type { AnchorComment } from "@/types/document-annotations";

type WordAnnotatorCommentsPanelProps = {
...
export function WordAnnotatorCommentsPanel({
  comments,
  selectedId,
  draftText,
  onSelect,
  ...
  onCancelDraft,
  onSaveComment,
}: WordAnnotatorCommentsPanelProps) {
  ...
  const handleCancelEdit = (e?: React.MouseEvent) => {
    ...
    if (selected && !selected.text.trim() && !editText.trim()) {
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ¿Eliminar este comentario y su ancla?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

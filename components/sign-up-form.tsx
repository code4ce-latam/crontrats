    ...
    <div className={cn("w-full max-w-md", className)} {...props}>
      <div className="bg-white rounded-2xl shadow-xl p-8">
        ...
        <Button
          ...
          variant="outline"
          className="w-full h-12 border-2 border-gray-200 hover:border-gray-300 bg-white text-gray-700 text-base font-medium rounded-lg flex items-center justify-center gap-3 shadow-sm hover:shadow-md transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
          disabled={isLoading || isLoadingGoogle || hasActiveSession}
        >
          {isLoadingGoogle ? (

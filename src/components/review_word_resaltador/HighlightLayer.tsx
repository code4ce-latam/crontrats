          ...
          >
            {showDeleteButton && (
              <button
                ...
                className="absolute -top-1 -left-1 z-20 flex h-5 w-5 items-center justify-center rounded-full bg-red-600 text-white shadow-lg transition-all hover:bg-red-700 hover:scale-110"
                style={{
                  fontSize: "14px",
                  lineHeight: "1",
                  fontWeight: "bold",

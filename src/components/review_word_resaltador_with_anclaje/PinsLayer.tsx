...
type PinsLayerProps = {
  ...
  // mapa id -> número global de comentario (1..N)
  orderMap: Record<string, number>;
  highlights: TextHighlight[]; // Para filtrar comentarios asociados a highlights
};
...
export function PinsLayer({
  ...
  // Filtrar comentarios que tienen un highlight asociado (no mostrar su pin)
